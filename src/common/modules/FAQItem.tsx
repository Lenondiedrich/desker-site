...
export default function FAQItem({ question, answer }: FAQItemType) {
  ...
  return (
    <div className="rounded-md border border-neutral-800 bg-neutral-900 transition-all duration-300 hover:bg-neutral-900/80">
      <div
        className="flex cursor-pointer items-center justify-between gap-5 px-6 py-4 text-base leading-relaxed tracking-wide text-gray-400"
        onClick={() => setIsOpen(!isOpen)}
      >
        <div className="flex items-center gap-2 text-sm sm:text-base">{question}</div>
