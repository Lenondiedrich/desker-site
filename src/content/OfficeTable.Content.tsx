  ...
  plans: [
    {
      ...
      features: ["Crie até 50 projetos simultâneos", "Até 05 colaboradores", "Convidados ilimitados"],
    },
    {
      name: "Plano Business",
      ...
      features: ["Projetos ilimitados, para sempre", "Até 10 colaboradores", "Convidados ilimitados"],
    },
    {
      ...
      features: ["Projetos ilimitados, para sempre", "Número de colaboradores personalizado", "Acesso pleno a todas as funcionalidades"],
    },
  ],
};
